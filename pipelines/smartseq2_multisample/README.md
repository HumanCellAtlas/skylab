...
| output_loom | Boolean description for optional Loom output | Boolean |
 ...
 The outputs of the Smart-seq2 Multi Sample workflow **Check if BAM output is transcriptome_aligned_bam or aligned_bam**
