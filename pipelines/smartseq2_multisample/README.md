...
| :----: | :---: | :----: | :--------------: |
| v.1.1.0 | June, 2020 | [Elizabeth Kiernan](mailto:ekiernan@broadinstitute.org) | Please file GitHub issues in skylab or contact [Kylee Degatano](mailto:kdegatano@broadinstitute.org) |
...
| output_loom | Boolean description for optional Loom output | Boolean |
 ...
 3) [LoomUtils.wdl](/library/tasks/LoomUtils.wdl): a task that produces Loom file output
