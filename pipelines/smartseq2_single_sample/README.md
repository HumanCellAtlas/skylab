...
Quality control measurements are calculated using [Picard tools](https://broadinstitute.github.io/picard/), command line tools used for manipulating high-throughput sequencing data. Picard uses the aligned BAM file generated with HISAT2 as input. 

There are three tasks that generate QC metrics in the pipeline. These are:

Picard.CollectMultipleMetrics
Picard.CollectRnaMetrics
Picard.CollectDuplicationMetrics


Below is a list of QC metrics generated by Picard which are collected in our pipeline:
