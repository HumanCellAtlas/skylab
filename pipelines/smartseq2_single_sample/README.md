...
The Smart-seq2 workflow code can be downloaded by cloning the GitHub [repository skylab](https://github.com/HumanCellAtlas/skylab). For the latest release of Smart-seq2, please see the [release tags prefixed with "Smartseq2"](https://github.com/HumanCellAtlas/skylab/releases).
