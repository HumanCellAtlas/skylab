...
The [HISAT2RSEM task](https://github.com/HumanCellAtlas/skylab/blob/master/library/tasks/HISAT2.wdl) uses the hisat2_ref_trans_index file and the sample fastq files to align reads to the reference transcriptome. The output of this task is an aligned BAM file and alignment log file.
